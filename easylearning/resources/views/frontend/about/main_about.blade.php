...
@php
    $aboutid = App\Models\About::find(1);
@endphp
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about__image">
                                <img src="{{$aboutid->about_image}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="about__content">
                                <div class="section__title">
                                    ...
                                    <h2 class="title">{{$aboutid->title}}</h2>
                                </div>
                                <div class="about__exp">
                                    ...
                                    <div class="about__exp__content">
                                        <p><span>{{$aboutid->short_title}}</p>
                                    </div>
                                </div>
                                <p class="desc">{{$aboutid->short_description}}</p>
